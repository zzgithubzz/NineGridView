...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
        ...
        if (doScroll) {
            if (mShowViewWhileRefreshing) {
                ...
                OnSmoothScrollFinishedListener listener = new OnSmoothScrollFinishedListener() {
                    @Override
                    public void onSmoothScrollFinished() throws InterruptedException {
                        callRefreshListener();
                    }
                };
    ...
    private void callRefreshListener() throws InterruptedException {
    ...
    public static interface OnRefreshListener2<V extends View> {
         ...
         */
        public void onPullUpToRefresh(final PullToRefreshBase<V> refreshView) throws InterruptedException;

    }

    static interface OnSmoothScrollFinishedListener {
        void onSmoothScrollFinished() throws InterruptedException;
    }
